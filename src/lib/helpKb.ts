...
export const HELP_KB: HelpEntry[] = [
  {
    ...
    a: 'Toque no microfone (no celular, no centro da barra de baixo; no computador, em "Nova Gravação") e escolha: gravar pelo microfone, gravar reunião no PC, enviar áudio, enviar vídeo, PDF/arquivo/texto, imagem ou link. A transcrição e o resumo são gerados automaticamente.',
